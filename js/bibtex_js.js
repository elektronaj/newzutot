...
function bibtex_js_draw() {
  ...
  (new BibtexDisplay()).displayBibtex($("#bibtex_input_journal_papers").val(), $("#bibtex_display_journal_papers"));
  (new BibtexDisplay()).displayBibtex($("#bibtex_input_peer_reviewed_papers").val(), $("#bibtex_display_peer_reviewed_papers"));
  // (new BibtexDisplay()).displayBibtex($("#bibtex_input_manuscripts").val(), $("#bibtex_display_manuscripts"));
}
...
if (typeof jQuery == 'undefined') {  
  ...
  $(document).ready(function () {
    ...
    if ($(".bibtex_template").size() == 0) {
      $("body").append("<div class=\"bibtex_template\"><div class=\"if author\" style=\"font-weight: bold;\">\n  <span class=\"if year\">\n    <span class=\"year\"></span>, \n  </span>\n  <span class=\"author\"></span>\n  <span class=\"if url\" style=\"margin-left: 20px\">\n    <a class=\"url\" style=\"color:black; font-size:10px\">(bla bla)</a>\n   <span class=\"if arxivurl\" style=\"margin-left: 20px\">\n    <a class=\"arxivurl\" style=\"color:red; font-size:10px\">(bla bla)</a>\n  </span>\n</div>\n<div style=\"margin-left: 10px; margin-bottom:5px;\">\n  <span class=\"title\"></span>\n</div></div>");
    }
